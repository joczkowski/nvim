...
_G.packer_plugins = {
  ...
  ["elixir.nvim"] = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/elixir.nvim",
  ...
  ["lightspeed.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/dev/.local/share/nvim/site/pack/packer/opt/lightspeed.nvim",
  ...
  ["nvim-tmux-navigation"] = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/nvim-tmux-navigation",
  ...
  ["telescope-dap.nvim"] = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/telescope-dap.nvim",
  ...
  ["vim-crystal"] = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/vim-crystal",
  ...
  ["vim-moonfly-colors"] = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/vim-moonfly-colors",
    url = "https://github.com/bluz71/vim-moonfly-colors"
  },
  ["vim-slime-syntax"] = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/vim-slime-syntax",
  ...
  ["vim-vsnip-integ"] = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/vim-vsnip-integ",
    url = "https://github.com/hrsh7th/vim-vsnip-integ"
  },
  vimux = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/vimux",
